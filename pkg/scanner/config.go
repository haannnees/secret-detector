...
import (
	...
	"github.com/haannnees/secret-detector/pkg/detectors/artifactory"
	"github.com/haannnees/secret-detector/pkg/detectors/aws"
	"github.com/haannnees/secret-detector/pkg/detectors/azure"
	"github.com/haannnees/secret-detector/pkg/detectors/basicauth"
	"github.com/haannnees/secret-detector/pkg/detectors/bearerauth"
	"github.com/haannnees/secret-detector/pkg/detectors/generic"
	"github.com/haannnees/secret-detector/pkg/detectors/github"
	"github.com/haannnees/secret-detector/pkg/detectors/jwt"
	"github.com/haannnees/secret-detector/pkg/detectors/keyword"
	"github.com/haannnees/secret-detector/pkg/detectors/mailchimp"
	"github.com/haannnees/secret-detector/pkg/detectors/npm"
	"github.com/haannnees/secret-detector/pkg/detectors/privatekey"
	"github.com/haannnees/secret-detector/pkg/detectors/sendgrid"
	"github.com/haannnees/secret-detector/pkg/detectors/slack"
	"github.com/haannnees/secret-detector/pkg/detectors/square"
	"github.com/haannnees/secret-detector/pkg/detectors/stripe"
	"github.com/haannnees/secret-detector/pkg/detectors/twilio"
	"github.com/haannnees/secret-detector/pkg/transformers/initransformer"
	"github.com/haannnees/secret-detector/pkg/transformers/jsontransformer"
	"github.com/haannnees/secret-detector/pkg/transformers/xmltransformer"
	"github.com/haannnees/secret-detector/pkg/transformers/yamltransformer"
)
